...
export default function DiaryListScreen() {
    ...
    return (
        <View style={styles.container}>
            {diaries.length === 0 ? (
                <Text style={{ textAlign: 'center', marginTop: 450, fontSize: 16}}>📭 Không có nhật ký</Text>
            ) : (
                <FlatList
                    data={diaries}
...
const styles = StyleSheet.create({
    container: { padding: 16, flex: 1, marginTop: 80},
    card: {
        marginBottom: 12,
        padding: 16,
        borderRadius: 12,
    ...
    frequency: { fontStyle: 'italic', marginTop: 4, color: 'white' },
    fab: {
        position: 'absolute',
        bottom: 24,
        right: 24,
